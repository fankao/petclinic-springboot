...
(
    ...
    CONSTRAINT pk_vet_specialities PRIMARY KEY (speciality_id, vet_id)
);
...
ALTER TABLE vet_specialities
    ADD CONSTRAINT fk_vetspe_on_speciality FOREIGN KEY (speciality_id) REFERENCES specialities (id);
